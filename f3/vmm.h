 ...
 * and reads the value from main memory at the physical address
 * 
 ...
 *
 * the CPU will call this to write a value to a virtual address
 * this function converts the virtual address to a physical address
 * and write the value from main memory at the physical address
 * 
 * this is the only function that writes directly to mainMem[]
 */
